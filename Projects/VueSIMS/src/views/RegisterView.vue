<script setup lang="ts">
	...
	const rules = {
		...
		confirmPassword: [
			...
			{ validator: validateConfirmPassword, trigger: 'blur' } // 新增的验证规则
		]
	}
	...
	<div class="login-container" style="z-index: 9;">
		...
		<transition name="fade-up">
			<el-card class="login-box">
				...
				<el-form ref="registerFormRef" style="max-width: 600px" :model="registerForm" :rules="rules" label-width="auto"
					:size="formSize">
					<!-- 用户名输入 -->
